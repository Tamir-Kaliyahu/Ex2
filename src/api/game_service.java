...
/**
 * This interface represents the gameClient.main functionality of the game-server, allowing a User the following:
 * 1. construct_a_Game(int type);
 * 2. getInfo(); getGraph(), getAgents(), getPokemon(); // JSON format:
 * 3. locateAgents();
 * 4. start_game()
 * 5. move(); // move all Agents
 * 6. chooseNextEdge(int agentID, int destNodeID); //gameClient.main algorithm
 * 7. stop_game()
...
public interface game_service extends Serializable {
    ...
    /**
     * This method is the gameClient.main logical functionality, allows the client algorithm
